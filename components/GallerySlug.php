...
class GallerySlug extends ComponentBase
{
    ...
    {
        return [
            'name'        => 'eriks.gallery::lang.galleryslug.title',
            'description' => 'eriks.gallery::lang.galleryslug.description',
        ];
    }
    ...
    public function defineProperties()
    {
        return [
            'slug'         => [
                'title'       => 'eriks.gallery::lang.slug.title',
                'description' => 'eriks.gallery::lang.slug.description',
                'default'     => '{{:slug}}',
                'type'        => 'string',
            ],
            'lang'         => [
